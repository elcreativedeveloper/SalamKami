const elcreativeDev = document.getElementById('elcreativeDev');
...
// splide
const main = new Splide('#elcreativeDev', {
    type: 'fade',
    direction: 'ttb',
    height: '100%',
    perPage: 1,
...
// tampilkan nama tamu
var guestName = elcreativeDev.dataset.guest;
...
var groupName = elcreativeDev.dataset.group;
...
var invToggle = (e) => {
    ...
    elcreativeDev.classList.remove('not-open');
...
var notSupport = document.getElementById('notSupport');
            function checkBrowser() {
                if ((navigator.userAgent.indexOf('Opera') || navigator.userAgent.indexOf('OPR')) != -1) {
                    ...
                    // elcreativeDev.style.display = "none";
